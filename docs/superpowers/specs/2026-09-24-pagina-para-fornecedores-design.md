...
| Débito falhou: 3 dias de tolerância; depois o perfil sai do marketplace até regularizar | `SupplierBillingService.suspendOverdueSubscriptions` (`GRACE_PERIOD_DAYS = 3`) |
