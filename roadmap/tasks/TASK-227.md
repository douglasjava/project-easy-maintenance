...
Lista de 10 queries (confirmada via `AskUserQuestion` antes de implementar — "cobre tudo, pode
seguir"), salva num arquivo `.sql` único com seções tituladas (opção escolhida sobre "um arquivo
por query").
