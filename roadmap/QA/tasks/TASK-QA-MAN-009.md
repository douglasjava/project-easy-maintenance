...
- [x] C1: navegação condicional por role validada
- [x] C2: listagem com membros, orgs, UsageMeter e badges funcionando
- [x] C3: fluxo completo de convite com e-mail de primeiro acesso + multi-org
- [x] C4: guard ADMIN bloqueando frontend e backend
- [x] C5: membro acessa exatamente as orgs selecionadas (não mais, não menos)
- [x] C6: sem reenvio de convite para e-mail já existente
- [x] C7: limite `maxUsers` bloqueado com mensagem de upgrade
- [x] C8: edição de role e orgs reflete imediatamente na listagem
- [x] C9: remoção desvincula sem apagar conta do sistema
