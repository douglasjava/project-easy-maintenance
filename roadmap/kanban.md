...
> [api#75](https://github.com/douglasjava/easy-maintenance-api/pull/75). Biblioteca de 13 queries
...
> sem item cadastrado) num arquivo único fora das migrations Flyway. Motivada por clientes reais
> entrando em TRIAL — evita reescrever SELECT toda hora. Recomendado rodar cada query uma vez
> contra o banco real antes de usar no dia a dia (schema conferido via migrations e onboarding,
> mas sem acesso direto ao banco pra testar).
...
|-------------------------------|---------------------------------------------------------------------------------|------------|----------|
| [TASK-227](tasks/TASK-227.md) | Infra: biblioteca de 13 queries SQL de acompanhamento de clientes (trial/pagantes/atraso/leads convertidos) — PR aberta [api#75](https://github.com/douglasjava/easy-maintenance-api/pull/75) | 🟡 Médio | — |
